...
def generate_2048_games(size=4, num_games=1000):
    ...
    for i in range(num_games):
        ...
        game.board = np.random.choice([0, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024], size=(size, size), replace=True, p=[0.30, 0.2, 0.16, 0.1, 0.08, 0.06, 0.04, 0.02, 0.02, 0.01, 0.01]) # randomly generate 2048 game boards
        games.append(game)
    return games
